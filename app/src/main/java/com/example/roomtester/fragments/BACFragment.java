...
import com.example.roomtester.Profile;
import com.example.roomtester.R;
import com.example.roomtester.databinding.DrinkRowItemBinding;
import com.example.roomtester.databinding.FragmentBacBinding;
...
public class BACFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId() == R.id.action_add){
            ...
            //(Reset menu item) Delete all the drinks
    ...
    private void getDrinksAndNotifyAdapter(){
        //get all the drinks from the database and notify the adapter that the data has changed.

        mDrinks = (ArrayList<Drink>) database.drinkDAO().getAll();
            ...
            public void setupUI(Drink drink){
                ...
                mBinding.imageViewDelete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        database.drinkDAO().delete(mDrink);
